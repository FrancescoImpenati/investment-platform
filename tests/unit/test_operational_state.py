...
def test_fresh_database_uses_exact_managed_location_and_complete_schema(
    ...
    assert {
        ...
        "raw_acquisition_adoptions",
        "raw_replay_operations",
        "quarantine_artifacts",
        "semantic_noop_commits",
        "semantic_noop_supporting_batches",
        "calendar_snapshot_reconciliations",
        "calendar_coverage_rebindings",
        "calendar_watermark_rebindings",
        "calendar_stale_gap_provenance",
        "calendar_stale_gap_coverage",
        "coverage_origin_rebindings",
        "ingestion_execution_limits",
        "request_execution_limits",
        "ingestion_dispatch_claims",
